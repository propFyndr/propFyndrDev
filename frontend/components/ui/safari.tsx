...
export function Safari({
  ...
  const clipPathId = `path0-${uid}`
  const roundedBottomId = `roundedBottom-${uid}`
  ...
  return (
    ...
    >
      ...
      {/* Interactive Content Viewport Layer */}
      {children && (
        <div
          className="absolute z-0 overflow-hidden flex flex-col"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
      ...
      {/* Safari Window Chrome SVG Overlay */}
      <svg
      ...
      >
        ...
        >
          ...
          <path
            ...
            className="fill-[#E5E5E5] dark:fill-[#2a2a2c]"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <path
            ...
            className="fill-[#F6F6F6] dark:fill-[#1e1e20]"
          />

          {/* Window Control Buttons (Apple macOS Traffic Lights) */}
          {coloredControls ? (
            <>
              <circle
                cx="27"
                cy="25"
                r="6"
                className="fill-[#FF5F56] stroke-[#E0443E]/40 stroke-[0.5]"
              />
              <circle
                cx="47"
                cy="25"
                r="6"
                className="fill-[#FFBD2E] stroke-[#DEA123]/40 stroke-[0.5]"
              />
              <circle
                cx="67"
                cy="25"
                r="6"
                className="fill-[#27C93F] stroke-[#1AAB29]/40 stroke-[0.5]"
              />
            </>
          ) : (
            <>
              <circle
                ...
                cy="25"
                r="6"
                className="fill-[#D1D1D6] dark:fill-[#48484A]"
              />
              <circle
                cx="47"
                cy="25"
          ...
          {/* Safari URL / Search Capsule */}
          <path
            d="M286 17C286 13.6863 288.686 11 292 11H946C949.314 11 952 13.6863 952 17V35C952 38.3137 949.314 41 946 41H292C288.686 41 286 38.3137 286 35V17Z"
            className="fill-[#EBEBEF] dark:fill-[#2d2d30]"
          />
          ...
          <g className="mix-blend-luminosity">
            <text
              x="580"
              y="30"
              className="fill-zinc-600 dark:fill-zinc-300 font-sans"
              fontSize="12"
              fontWeight="500"
              letterSpacing="0.2px"
            >
